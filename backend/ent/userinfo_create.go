...
func (uic *UserInfoCreate) SetUserID(i int) *UserInfoCreate {
	uic.mutation.SetUserID(i)
	return uic
}

// SetTitle sets the "title" field.
func (uic *UserInfoCreate) SetTitle(s string) *UserInfoCreate {
	uic.mutation.SetTitle(s)
	return uic
}

// SetBody sets the "body" field.
func (uic *UserInfoCreate) SetBody(s string) *UserInfoCreate {
	uic.mutation.SetBody(s)
	return uic
}
...
func (uic *UserInfoCreate) SetUser(u *User) *UserInfoCreate {
...
func (uic *UserInfoCreate) check() error {
	...
	if v, ok := uic.mutation.UserID(); ok {
	...
	if _, ok := uic.mutation.Title(); !ok {
		return &ValidationError{Name: "title", err: errors.New(`ent: missing required field "UserInfo.title"`)}
	}
	if v, ok := uic.mutation.Title(); ok {
	...
	if _, ok := uic.mutation.Body(); !ok {
		return &ValidationError{Name: "body", err: errors.New(`ent: missing required field "UserInfo.body"`)}
	}
	if v, ok := uic.mutation.Body(); ok {
	...
	if _, ok := uic.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "UserInfo.user"`)}
	}
	return nil
}
...
func (uic *UserInfoCreate) createSpec() (*UserInfo, *sqlgraph.CreateSpec) {
	...
	if value, ok := uic.mutation.Title(); ok {
		_spec.SetField(userinfo.FieldTitle, field.TypeString, value)
		_node.Title = value
	}
	if value, ok := uic.mutation.Body(); ok {
