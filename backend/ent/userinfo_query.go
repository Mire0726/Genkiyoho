...
func (uiq *UserInfoQuery) QueryUser() *UserQuery {
...
func (uiq *UserInfoQuery) WithUser(opts ...func(*UserQuery)) *UserInfoQuery {
	query := (&UserClient{config: uiq.config}).Query()
...
func (uiq *UserInfoQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserInfo, error) {
	...
	if query := uiq.withUser; query != nil {
		if err := uiq.loadUser(ctx, query, nodes, nil,
			func(n *UserInfo, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uiq *UserInfoQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserInfo, init func(*UserInfo), assign func(*UserInfo, *User)) error {
...
func (uiq *UserInfoQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := uiq.ctx.Fields; len(fields) > 0 {
		...
		if uiq.withUser != nil {
			_spec.Node.AddColumnOnce(userinfo.FieldUserID)
		}
	}
