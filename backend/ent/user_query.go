...
// QueryUserinfo chains the current query on the "userinfo" edge.
...
// the "userinfo" edge. The optional arguments are used to configure the query builder of the edge.
...
func (uq *UserQuery) loadUserinfo(ctx context.Context, query *UserInfoQuery, nodes []*User, init func(*User), assign func(*User, *UserInfo)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userinfo.FieldUserID)
	}
