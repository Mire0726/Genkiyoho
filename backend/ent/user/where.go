...
// HasUserinfo applies the HasEdge predicate on the "userinfo" edge.
...
// HasUserinfoWith applies the HasEdge predicate on the "userinfo" edge with a given conditions (other predicates).
